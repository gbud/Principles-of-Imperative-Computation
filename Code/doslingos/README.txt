...
Files you will modify:
   doslingos-test.c0    - test your doslingos code

Files you won't modify:
   lib/int_arrayutil.c0     - A version of arrayutil.c0 for ints
   lib/string_arrayutil.c0  - A version of arrayutil.c0 for strings
...
Compiling doslingos.c0 and tests:
   % cc0 -d -W -w -o doslingos lib/*.c0 doslingos.c0 doslingos-test.c0
   % ./doslingos
...
Compiling analysis.c0:
   % cc0 -W -w -o analysis lib/*.c0 doslingos.c0 analysis.c0
