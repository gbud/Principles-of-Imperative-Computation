...
Files you won't modify:
   ...
   lib/stack_of_string.c0          - Stacks containing strings (stack_t)
   lib/queue_of_string.c0          - Queues containing strings (queue_t)
   lib/stack_of_stack_of_string.c0 - Stacks containing stacks of strings (sstack_t)
...
Compiling and running the dictionary and provided tests:
   % cc0 -d -W -w -o dict-test lib/*.c0 dict.c0 dict-test.c0
   % ./dict-test

Compiling and running your tests for is_precstack
   % cc0 -d -W -w -o is_precstack-test lib/*.c0 dict.c0 parse.c0 is_precstack-test.c0
   % ./is_precstack-test

Compiling and running the parser:
   % cc0 -d -W -w -o exp lib/*.c0 clac.c0 dict.c0 parse.c0 exp-main.c0
   % ./exp
   EXP>> 1 + 3 * 4 == 13
   % ./exp -x
   EXP>> 1 + -3 * 4 / -2 ** 3
...
Compiling and running the parser tests:
   % cc0 -d -W -w -o exp-test lib/*.c0 clac.c0 dict.c0 parse.c0 exp-test.c0
   % ./exp-test
