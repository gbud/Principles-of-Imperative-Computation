...
Compiling tasks.c0:
   % cc0 -d -W -o tasks-test1 pixel-array.c0 tasks.c0 tasks-test.c0
   % ./tasks-test1
...
Compiling tasks.c0 against pixel-int.c0:
   % cc0 -d -W -o tasks-test2 pixel-int.c0 tasks.c0 tasks-test.c0
   % ./tasks-test2
...
Submitting from the command line on andrew:
   % autolab122 handin pixels tasks.c0 pixel-int.c0 respect.c0 pixel-bad.c0 pixel-test.c0
then display autolab's feedback by running:
   % autolab122 feedback

Creating a tarball to submit with autolab.andrew.cmu.edu web interface:
   % tar -czvf handin.tgz tasks.c0 pixel-int.c0 respect.c0 pixel-bad.c0 pixel-test.c0
