...
Compiling C0 code with contracts:
   % cc0 -d -W -w lib/*.c0 strbuf.c0 strbuf-test.c0
   % ./a.out

Compiling C0 code without contracts:
   % cc0 -W -w lib/*.c0 strbuf.c0 strbuf-test.c0
   % ./a.out

Compiling C code with contracts:
   % gcc -DDEBUG -fsanitize=undefined -g -Wall -Wextra -Werror -Wshadow -std=c99 -pedantic lib/*.c strbuf.c strbuf-test.c
   % ./a.out

Compiling C code without contracts:
   % gcc -Wall -Wextra -Werror -Wshadow -std=c99 -pedantic lib/*.c strbuf.c strbuf-test.c
   % ./a.out
